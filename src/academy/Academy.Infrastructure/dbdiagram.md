...
erDiagram
  ...
  "public.institutions" {
    ...
    did character varying(200)(NULL) 
    issuer_wallet_address character varying(42)(NULL) 
  ...
  "public.user_global_roles" }o--|| "public.users" : user_global_roles_user_id_fkey
  ...
  "public.institution_invitations" {
    id uuid PK
    institution_id uuid FK
    email character varying(200) 
    token_hash character(64) 
    invitation_url character varying(700) 
  ...
  "public.institution_invitations" }o--|| "public.institutions" : institution_invitations_institution_id_fkey
  "public.institution_invitations" }o--|| "public.users" : institution_invitations_accepted_by_user_id_fkey
  "public.institution_invitations" }o--|| "public.users" : institution_invitations_created_by_user_id_fkey
  "public.students" {
    id uuid PK
    institution_id uuid FK
  ...
  "public.verification_logs" {
    ...
    signature_validation_source character varying(32)(NULL) 
    revocation_source character varying(16)(NULL) 
  }
  ...
  "public.holder_profiles" {
    user_id uuid PK,FK
    full_name character varying(180)(NULL) 
    birth_date date(NULL) 
    contact_email character varying(200)(NULL) 
    country_code character varying(2)(NULL) 
    phone_number character varying(40)(NULL) 
    created_at timestamp without time zone 
    updated_at timestamp without time zone 
  }
  "public.holder_profiles" }o--|| "public.users" : holder_profiles_user_id_fkey
```
