# issuer-holder-credentials Specification

## Purpose

Contrato HTTP y de lectura para consultas holder en el servicio issuer: endpoints autenticados con JWT SIWE, OpenAPI con Bearer y enum `status`, snapshot versionado y proyección de listado/detalle para el portal web.
