# verifier-infrastructure-persistence Specification

## Purpose

Define las convenciones de la capa de persistencia del servicio `verifier`: un modelo EF database-first propio y acotado, namespaces alineados, una composición DI Postgres-only mediante interfaces de Application, y tests de integración contra un PostgreSQL efímero.
